...
class EventManager
{
     ...
     * 有效字符
     */
    const CHARS = '0123456789ABCDEFGHIJKLMNOPQRSTU_VWXYZabcdefghijklmnopqrstuvwxyz';
     ...
     */
    static function update(string $name, Event $event): void
    {
     ...
     * @param string $data 数据
     */
    static function updateData(string $name, string $data): void
    {
        Event::validate($data);
